    ...
    class Twispay extends PaymentModule
    {
        ...
        */
        ...
        public function install()
        {
            ...
            Configuration::updateValue('TWISPAY_IFRAME_FORM', false);
        ...
        public function uninstall()
        {
            ...
            Configuration::deleteByName('TWISPAY_IFRAME_FORM');
        ...
        */
        ...
        public static function getKeysInfo()
        {
            ...
            $info['isIframe'] = Configuration::get('TWISPAY_IFRAME_FORM');
        ...
        protected function getConfigFormValues()
        {
            return array(
                ...
                'TWISPAY_IFRAME_FORM' => Configuration::get('TWISPAY_IFRAME_FORM'),
        ...
        */
        public function getPaymentVars($params = false)
        {
            ...
            $order_inputs['tags'] = ['prestashop', 'PS_' . _PS_VERSION_];
